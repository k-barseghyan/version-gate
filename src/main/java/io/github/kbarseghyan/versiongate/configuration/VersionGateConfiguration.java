...
/**
 * Composes the core around externally supplied storage-port beans.
 *
 * <p>A consuming application must provide exactly one compatible {@code ControlStore} and {@code
 * SnapshotStore}. No production storage implementation is supplied by the core artifact.
 */
...
public class VersionGateConfiguration {
  ...
  /** Creates the core bean configuration. */
